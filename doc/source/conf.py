...
project = u'sonata-network-reduction'
...
version = sonata_network_reduction.__version__
# The full version, including alpha/beta/rc tags.
release = sonata_network_reduction.__version__
...
# documentation.
html_theme_options = {
    'metadata_distribution': 'sonata_network_reduction',
}
...
html_title = u'sonata-network-reduction'
...
latex_documents = [
    ('index', 'sonata-network-reduction.tex', u'sonata-network-reduction Documentation',
